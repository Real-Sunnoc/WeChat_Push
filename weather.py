...
def get_weather(city_name):
    try:
        ...
        if city_id:
            ...
            # https://devapi.qweather.com/v7/weather/3d?key=0fd8b705c76b40099f21e66abc0e23f6&location=101190404
            ...
            print("qweather:", qweather)
            life_url = f"https://devapi.qweather.com/v7/indices/1d?type=3&location={city_id}&key={qweather}"
            # https://devapi.qweather.com/v7/indices/1d?type=3&location=101190404&key=0fd8b705c76b40099f21e66abc0e23f6
            life_json = requests.get(life_url).json()
            life_code = life_json["code"]
            if life_code.__eq__("200"):
                str = life_json["daily"][0]["text"]
                life_list = str.split('。')
                #print(life_list)
                #life_tip = "👔 " + life_json["daily"][0]["category"] + "。" + life_json["daily"][0]["text"]
                life_tip = "👔 " + life_json["daily"][0]["category"] + "。" + life_list[0] + "~"
